...
def calculate_cointegration(series_1, series_2):
  ...
  hedge_ratio = model.params[0] # ERROR: hedge_ratio = model.params[1]; "index 1 is out of bounds for axis 0 with size 1"; model has only 1 param, so can't access index 1
